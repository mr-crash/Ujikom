		...
		<div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    ...
                    <div class="grid wow zoomIn">
                        <figure class="effect-bubba">
                            <img src="{{url('clean/images/item-1.jpg')}}" alt="img01"/>
                            <figcaption>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    ...
                    <div class="grid wow zoomIn">
                        <figure class="effect-bubba">
                            <img src="{{url('clean/images/item-2.jpg')}}" alt="img01"/>
                            <figcaption>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    ...
                    <div class="grid wow zoomIn">
                        <figure class="effect-bubba">
                            <img src="{{url('clean/images/item-3.jpg')}}" alt="img01"/>
                            <figcaption>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    ...
                    <div class="grid wow zoomIn">
                        <figure class="effect-bubba">
                            <img src="{{url('clean/images/item-4.jpg')}}" alt="img01"/>
                            <figcaption>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    ...
                    <div class="grid wow zoomIn">
                        <figure class="effect-bubba">
                            <img src="{{url('clean/images/item-5.jpg')}}" alt="img01"/>
                            <figcaption>
                ...
                <div class="col-xs-12 col-sm-4 col-md-4">
                    ...
                    <div class="grid wow zoomIn">
                        <figure class="effect-bubba">
                            <img src="{{url('clean/images/item-6.jpg')}}" alt="img01"/>
                            <figcaption>
		...
		<div class="container">
			...
			<div id="cbp-qtrotator" class="cbp-qtrotator">
                <div class="cbp-qtcontent">
                    <img src="{{url('clean/images/client-1.jpg')}}" alt="client-1" />
                    <blockquote>
                ...
                <div class="cbp-qtcontent">
                    <img src="{{url('clean/images/client-2.jpg')}}" alt="client-2" />
                    <blockquote>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-6 col-sm-offset-3">
					...
					<form action="mailto:141510197@gmail.com" method="post" enctype="text/plain">
