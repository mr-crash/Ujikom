            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" align="center">
                	<table class="table table-hover">
                        ...
                        <thead>
                		<tr>
                			<th><a href="{{url('kategori_lembur/?sortBy=kode_lembur')}}">Kode</a></th>
                            <th>Jabatan</th>
                			<th>Golongan</th>
                		...
                		<tr>
                			...
                			<td><a href="{{url('jabatan',$data->jabatan->id)}}">{{$data->jabatan->nama_jabatan}}</a></td>
                            <td><a href="{{url('golongan',$data->golongan->id)}}">{{$data->golongan->nama_golongan}}</a></td>
                			<td class="action-web"><a href="{{url($root,$data->id)}}" class="btn btn-default">View</a></td>
                            <td class="action-web"><a href="{{route('kategori_lembur.edit',$data->id)}}" class="btn btn-warning lebar">Edit</a></td>
                            <td class="action-web">{!! Form::open(['method'=> 'DELETE', 'route'=>['kategori_lembur.destroy',$data->id]]) !!}
                            ...
                            <td class="action-mobile dropdown" colspan="3">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li><a href="{{route('kategori_lembur.edit',$data->id)}}">Edit</a></li>
                                </ul>
                            </td>
                		</tr>
                		@endforeach
